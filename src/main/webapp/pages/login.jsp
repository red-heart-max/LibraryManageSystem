        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="${pageContext.request.contextPath}/loginIn" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="password" name="password" lay-verify="required" placeholder="密码" autocomplete="off" class="layui-input" value="12345">
                </div>
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-username"></label>
                ...
                <div class="layui-form-item">
                    <button class="layui-btn layui-btn layui-btn-normal layui-btn-fluid" lay-submit="" lay-filter="login">密码登录</button>
                </div>
            </form>
            <div>
                <a href="${pageContext.request.contextPath}/toIndex">人脸登录</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    window.onload = function() {
        layui.use(['layer'], function () {
            var $ = layui.jquery
            $.ajax({
                url: "IndexSelectAllNotice", // 后端接口地址
                type: "GET", // 请求方式
